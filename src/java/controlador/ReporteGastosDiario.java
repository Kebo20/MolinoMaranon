 ...
 * @author kevin
 */
public class ReporteGastosDiario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for (compra c : compraDao.listar(mes, dia)) {
            ...
            for (servicio s : servicioDao.listar(mes,dia)) {
            ...
            out.print("<table  class=\"table table-bordered table-striped table-hover dataTable js-exportable  \">\n"
                    ...
                    + "                                    </thead>\n"
                    + "                                    <tbody>");
            for (sueldo s : sueldoDao.listar(mes,dia)) {
            ...
            out.print("<h2 style=\"color:#0e7379 \">Gastos del día: S/."+total+"</h2>");
