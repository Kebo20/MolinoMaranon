 ...
 * @author kevin
 */
public class ReporteVentasDiario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.print(" <table  class=\"table table-striped table-hover dataTable js-basic-example\" style=\"padding-bottom: 0px;padding-top: 0px;font-size: 12px;background-color: #ffffff\">\n"
                    ...
                    + "                                                    </thead>\n"
                    + "                                                    <tbody>");
            for (venta v1 : ventaDao.listar_numero_orden(mes, dia)) {
                out.print("                                     <tr>\n"
                        ...
                        + "                                                        </tr>");
                double suma = 0.0;
                for (venta v : ventaDao.listar(mes, dia, v1.getNumero_orden())) {
            ...
            out.print("</tbody>\n"
                        + "             </table>");
            out.print("<br>");
            out.print("<h2 style=\"color:#0e7379 \">Ventas del dia: S/."+total+"</h2>");
