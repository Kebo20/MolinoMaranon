$(function () {
    ...
    //Mobile Phone Number
    $demoMaskedInput.find('.mobile-phone-number').inputmask('+99 (999) 999-99-99', { placeholder: '___-___-___' });
    //Phone Number
    ...
    $demoMaskedInput.find('.money-sol').inputmask('99,99 €', { placeholder: 'S/. ___,__ ' });
