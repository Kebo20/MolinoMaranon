    ...
    <body class="theme-red">
                    ...
                    <ul class="list">
                        ...
                        <li>
                            <a href="trabajadores.jsp" >
                                <i class="material-icons"></i>
                                <span style="color: #0e7379">Trabajadores</span>
                            </a>
        ...
        <section class="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="body">
                                    ...
                                    <h2 class="title-1 m-b-25">Trabajadores
                                    ...
                                    <div class="table-responsive table--no-card m-b-40">
                                        ...
                                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                            ...
                                            <tbody>
                                                <% for (trabajador a : trabajadorDao.listar()) {%>
                                                <tr>



                                                    <td style="width: 25%" class="text-left"><%=a.getNombre()%></td>
                                                    <td style="width: 10%" class="text-left"><%=a.getCargo()%></td>
                                                    <td style="width: 10%" class="text-left"><%=a.getCelular()%></td>



                                                    <td style="width: 5%"  class="text-center"><button onclick="editar('<%=a.getId()%>', '<%=a.getNombre()%>', '<%=a.getCargo()%>', '<%=a.getCelular()%>')" class="btn bg-teal btn-lg waves-effect btn-xs">Editar</button></td>
                                                    <td style="width: 5%" class="text-center"><button     onclick='eliminar(<%=a.getId()%>)'  class="btn bg-teal btn-lg waves-effect btn-xs">Eliminar</button></td>
                                                </tr>
                                    ...
                                    <script>
                                        ...
                                        function editar(id, nombre, cargo, celular) {
                                            $('#ModalEditar').modal('show');
                                            $('#idTE').val(id);

                                            $('#cargoTE').val(cargo);
                                            $('#nombreTE').val(nombre);
                                            $('#celularTE').val(celular);
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="text-center" id="defaultModalLabel">Eliminar Trabajador</h4>
                        </div>
                        <div class="modal-body">
                            <p align="left" style="color: #000 "><big>¿Está seguro de eliminar este trabajador?</big></p>
                        </div>
                        <form action="trabajadorEliminar" method="post">  
                            <div class="modal-footer">
                                <button type="submit" name="trabajador" id="btneliminar" class="btn  bg-teal waves-effect">Eliminar</button>
            ...
            <div class="modal fade" id="ModalEditar" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form action="trabajadorEditar" method="post"> 
                            <div class="modal-header">
                                <h4 class="text-center" >Editar Trabajador</h4>
                            </div>
                            <div class="modal-body">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">   
                                        <div class="section__content section__content--p30">
                                            ...
                                            <div class="body">
                                                <input type="hidden" id="idTE" name="id">   
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input  type="text" id="nombreTE" name="nombre" class="form-control text"  placeholder="Nombres del agricultor" autocomplete="off" required>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input   class="form-control" id="cargoTE" name="cargo" required  placeholder="Ocupación en la empresa" >
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input   class="form-control" id="celularTE" name="celular"  onkeypress="return justNumbers();" placeholder="999 999 999" autocomplete="off">
            ...
            <div class="modal fade" id="ModalRegistrar" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form action="trabajadorRegistrar" method="post"> 
                            <div class="modal-header">
                                <h4 class="text-center"  >Registrar Trabajador</h4>
                            </div>
                            <div class="modal-body">
                                            ...
                                            <div class="body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input   class="form-control" id="cargo" name="cargo"   required placeholder="Ocupación en la empresa" >
