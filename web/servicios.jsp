            ...
            <div class="modal fade" id="mdModal" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form action="servicioRegistrar" method="get"> 
                            <div class="modal-header">
                                <h4 class="text-center">Realizar pago a proveedor</h4>
                            </div>
                                            ...
                                            <div class="body">
                                                <div class="demo-masked-input">
                                                    <div class="row">
                                                        ...
                                                        <select id="proveedor" name="proveedor" class="form-control show-tick" required data-live-search="true" >
                                                    ...
                                                    <div class="row ">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <div class="form-line">
                                                                ...
                                                                <input  name="fecha" id="fecha"  required type="date"  class="form-control"   autocomplete="off">
                                                    ...
                                                    <div class="row ">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <div class="form-line">
                                                                ...
                                                                <input  name="comprobante" id="comprobante" required onkeypress="return justNumbers();" class="form-control"  maxlength="12" placeholder="" autocomplete="off">
                                                    ...
                                                    <div class="row ">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <div class="form-line">
                                                                ...
                                                                <input id="importe" name="importe" required onkeypress="return justNumbers();" class="form-control"   placeholder="" autocomplete="off">
                                                    ...
                                                    <div class="row ">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <div class="form-line">
                                                                ...
                                                                <input  name="descripcion" id="descripcion"  class="form-control"  maxlength="12" placeholder="" autocomplete="off">
            ...
            <div class="modal fade" id="ModalEliminar" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="servicioEliminar" method="post">  
                            <div class="modal-footer">
                                <button type="submit" name="id" id="btneliminar" class="btn  bg-teal waves-effect">Eliminar</button>
