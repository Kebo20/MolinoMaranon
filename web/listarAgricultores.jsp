                    ...
                    <ul class="list">
                        ...
                        <li>
                            <a href="listarAgricultores.jsp"  >
                                <i class="material-icons"></i>
                                <span style="color: #0e7379">Agricultores</span>
                            </a>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="body">
                                    ...
                                    <h2 class="title-1 m-b-25">Agricultores
                                        ...
                                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 10%" class="text-left"><%=a.getDni()%></td>
                                                    ...
                                                    <td style="width: 5%"  class="text-center"><button onclick="editar('<%=a.getId()%>', '<%=a.getCodigo()%>', '<%=a.getDni()%>', '<%=a.getNombre()%>', '<%=a.getCelular()%>', '<%=a.getDescripcion()%>')" class="btn bg-teal btn-lg waves-effect btn-xs">Editar</button></td>
                                            ...
                                            <div class="body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input type="text" id="codigo" name="codigo" class="form-control"     placeholder="Código del agricultor" autocomplete="off" required>
                                            ...
                                            <div class="body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input type="text"  name="codigo" class="form-control"     placeholder="Código del agricultor" autocomplete="off" required>
