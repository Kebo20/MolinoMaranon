            ...
            <div class="modal fade" id="mdModal" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form action="sueldoRegistrar" method="post"> 
                                            ...
                                            <div class="body">
                                                <div class="demo-masked-input">
                                                    <div class="row">
                                                        ...
                                                        <select id="trabajador" name="trabajador" class="form-control show-tick" required data-live-search="true" >
                                                            <option value="" >Seleccione trabajador</option>
                                                            <%for (trabajador t : trabajadorDao.listar()) {%>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <select id="mes" name="mes" class="form-control show-tick" required data-live-search="true" >
                                                    ...
                                                    <div class="row ">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <div class="form-line">
                                                                ...
                                                                <input  name="comprobante" id="comprobante" onkeypress="return justNumbers();" class="form-control" required maxlength="12" placeholder="" autocomplete="off">
                                                    ...
                                                    <div class="row ">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <div class="form-line">
                                                                ...
                                                                <input id="monto" name="monto" onkeypress="return justNumbers();" class="form-control" required maxlength="12" placeholder="" autocomplete="off">
            ...
            <div class="modal fade" id="ModalEliminar" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="sueldoEliminar" method="post">  
                            <div class="modal-footer">
                                <button type="submit" name="sueldo" id="btneliminar" class="btn  bg-teal waves-effect">Eliminar</button>
