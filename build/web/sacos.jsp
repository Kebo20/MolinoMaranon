    ...
    <body class="theme-red">
        ...
        <section class="content">
                                        ...
                                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 25%" class="text-center"><%=s.getNombre()%></td>
                                                   



                                                    <td style="width: 5%"  class="text-center"><button onclick="editar('<%=s.getId()%>', '<%=s.getNombre()%>')" class="btn bg-teal btn-lg waves-effect btn-xs">Editar</button></td>
                                                    <td style="width: 5%" class="text-center"><button     onclick='eliminar(<%=s.getId()%>)'  class="btn bg-teal btn-lg waves-effect btn-xs">Eliminar</button></td>
                                                </tr>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="text-center" id="defaultModalLabel">Eliminar saco</h4>
                        </div>
                        <div class="modal-body">
                            <p align="left" style="color: #000 "><big>¿Está seguro de eliminar este saco?</big></p>
                        </div>
                        <form action="sacoEliminar" method="post">  
                            <div class="modal-footer">
                                <button type="submit" name="saco" id="btneliminar" class="btn  bg-teal waves-effect">Eliminar</button>
            ...
            <div class="modal fade" id="ModalEditar" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form action="sacoEditar" method="post"> 
                            <div class="modal-header">
                                            ...
                                            <div class="body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input  type="text" id="nombreTE" name="nombre" class="form-control text"  placeholder="Nombre del saco" autocomplete="off" required>
            ...
            <div class="modal fade" id="ModalRegistrar" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form action="sacoRegistrar" method="post"> 
                            <div class="modal-header">
                                <h4 class="modal-title"  >Registrar saco</h4>
                            </div>
                            <div class="modal-body">
                                            ...
                                            <div class="body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input  type="text" id="nombre" name="nombre" class="form-control text"   placeholder="Nombre de saco" autocomplete="off" required>
