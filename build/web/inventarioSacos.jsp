                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="body">
                                    ...
                                    <h2 class="title-1 m-b-25">Inventario de sacos
                                    </h2>
                                        ...
                                        <table class="table table-bordered table-striped table-hover js-exportable dataTable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 10%" class="text-center"><%=entrada_sacoDao.cantidad_sacos(s.getId())%></td>
                                                    <td style="width: 10%" class="text-center"><%=ventaDao.cantidad_sacos(s.getId())%></td>
                                                    <%int stock = entrada_sacoDao.cantidad_sacos(s.getId()) - ventaDao.cantidad_sacos(s.getId());%>
                                                    <td style="width: 10%" class="text-center"><b><%=stock%></b></td>
                                         ...
                                         <a  class="btn bg-teal"  href="sacos.jsp" style="font-size: 15px">
                                            Registrar sacos
                                         </a>        
                                         <a  class="btn bg-teal"  href="entradaSaco.jsp" style="font-size: 15px">
                                            Entrada de sacos
                                         </a>        
            ...
            <div class="modal fade" id="ModalEditar" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form action="inventarioSacosEditar" method="post"> 
                                            ...
                                            <div class="body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input  type="text" id="sacoE"  class="form-control text"  placeholder="Nombres del artículo en inventario" autocomplete="off" readonly required>
                                                            <input  type="hidden" id="nombreE" name="nombre"  >
                                                ...
                                                <input  type="hidden" class="form-control" id="marcaE" name="marca"   >
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input   class="form-control" id="cantidadE" name="cantidad"  onkeypress="return justNumbers();" placeholder="" autocomplete="off">
                                                ...
                                                <input   class="form-control" id="valorE" name="valor"  onkeypress="return justNumbers();" type="hidden">
