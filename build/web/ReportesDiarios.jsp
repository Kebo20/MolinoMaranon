                    ...
                    <ul class="list">
                        ...
                        <li>
                            <a href="ReportesDiarios.jsp">
                                ...
                                <span style="color:#0e7379 ">Reportes Diarios</span>
                            </a>
                        </li>
                        <li>
                                                    ...
                                                    <div class="row clearfix">
                                                        ...
                                                        <form id="formV">         
                                                            <div class="col-md-3">
                                                                ...
                                                                <select id="diaV"    class="form-control show-tick" data-live-search="true"  >
                                                                    <%for (int i = 1; i < 32; i++) {%>
                                                            ...
                                                            <a onclick="VerVentasDiario()" class="btn bg-teal  btn-lg waves-effect" >
                                                                ver
                                                            </a>
                                                        </form> 
                                                    </div>
                                                    <div class="row clearfix">
                                                        ...
                                                        <form id="formG">         
                                                            <div class="col-md-3">
                                                                ...
                                                                <select id="diaG"    class="form-control show-tick" data-live-search="true"  >
                                                                    <%for (int i = 1; i < 32; i++) {%>
                                                                    <option value="<%=i%>"><%=i%></option>
                                                                    <%  }%>
                                                                </select>
                                                            ...
                                                            <a onclick="VerGastosDiario()" class="btn bg-teal  btn-lg waves-effect" >
                                                                ver
                                                            </a>
                                                        </form> 
                                                    </div>
